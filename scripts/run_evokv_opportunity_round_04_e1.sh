...
config=configs/evokv_root_cause/kuairand_target_aware_author_20260807_v0.json
output=results/opportunity_discovery/evokv_opportunity_discovery_20260807_v0/round_04_e1_kuairand_target_aware
mkdir -p "$output"
