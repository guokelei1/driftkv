...
xp_source_version="${EVOKV_SOURCE_VERSION:-1}"
xp_target_version="${EVOKV_TARGET_VERSION:-2}"
...
xp_checkpoint_root="checkpoints/evokv_xp_qk_e4096_h1536/quality_rounds/quality_lr_dual_20260802_round1_lr015"
