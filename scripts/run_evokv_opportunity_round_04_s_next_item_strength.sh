...
config=configs/evokv_root_cause/kuairand_next_item_update_strength_20260807_v0.json
output=results/opportunity_discovery/evokv_opportunity_discovery_20260807_v0/round_04_s1_next_item_strength
mkdir -p "$output"
