...
config=configs/evokv_root_cause/kuairand_prediction_query_active_catalog_20260808_v4.json
output=results/opportunity_discovery/evokv_kuairand_query_20260808_v0/active_catalog_seed4217
mkdir -p "$output"
