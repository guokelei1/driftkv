...
CONFIG="${1:-configs/evokv_root_cause/qk_attribution_round_03_a_canary_two_gpu_v0.json}"
ROUND_ROOT="results/root_cause_campaign/evokv_root_cause_20260807_v0/round_03_a_qk_attribution_canary"
