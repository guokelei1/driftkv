...
config=configs/evokv_root_cause/kuairand_amplified_theta3_primary_gate_20260809_v3.json
selection_root=results/root_cause_campaign/kuairand_amplified_theta3_primary_gate_seed53117_v3
...
python -c 'from hstu_kvcache.streaming.kuairand_lineage_retrain import load_lineage_retrain_config; load_lineage_retrain_config("configs/evokv_root_cause/kuairand_amplified_theta3_primary_gate_20260809_v3.json")'
