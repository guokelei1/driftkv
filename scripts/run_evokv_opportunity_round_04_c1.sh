...
config=configs/evokv_root_cause/kuairand_history_residual_engagement_20260807_v0.json
output=results/opportunity_discovery/evokv_opportunity_discovery_20260807_v0/round_04_c1_kuairand_history_residual
mkdir -p "$output"
