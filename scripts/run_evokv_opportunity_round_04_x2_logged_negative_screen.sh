...
config=configs/evokv_root_cause/kuairand_next_item_logged_negative_screen_20260807_v1.json
output=results/opportunity_discovery/evokv_opportunity_discovery_20260807_v0/round_04_x2_theta8_logged_negative_screen
mkdir -p "$output"
