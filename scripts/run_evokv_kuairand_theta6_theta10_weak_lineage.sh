...
config=configs/evokv_root_cause/kuairand_amplified_theta6_theta10_weak_lineage_20260809_v0.json
protocol=configs/evokv_root_cause/kuairand_extended_triangle_acceptance_20260809_v0.json
selection_root=results/root_cause_campaign/kuairand_amplified_theta6_theta10_weak_lineage_seed53117_v0
...
python -c 'from hstu_kvcache.streaming.kuairand_lineage_retrain import load_lineage_retrain_config; load_lineage_retrain_config("configs/evokv_root_cause/kuairand_amplified_theta6_theta10_weak_lineage_20260809_v0.json")'
