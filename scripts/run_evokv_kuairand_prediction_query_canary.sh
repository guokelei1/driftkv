...
config=configs/evokv_root_cause/kuairand_prediction_query_canary_20260808_v0.json
output=results/opportunity_discovery/evokv_kuairand_query_20260808_v0/canary_seed4217
mkdir -p "$output"
