...
BINDING = QKStreamFullCatalogBinding(
    ...
    target_version=2,
    edge=2,
    candidate_name="theta2_route_a_e3_lr150",
    dense_learning_rate=2.25e-5,
    projection_learning_rate=2.25e-5,
    embedding_learning_rate=2.25e-4,
    epochs=3,
...
def main() -> None:
    result = run_full_catalog_tuning_edge(parse_args().config, BINDING)
