...
config=configs/evokv_root_cause/kuairand_amplified_theta5_refinement_20260809_v1.json
protocol=configs/evokv_root_cause/kuairand_extended_triangle_acceptance_20260809_v0.json
selection_root=results/root_cause_campaign/kuairand_amplified_theta5_refinement_seed53117_v1
...
assessment="$selection_root/theta5_extended_acceptance.json"

python -c 'from hstu_kvcache.streaming.kuairand_lineage_retrain import load_lineage_retrain_config; load_lineage_retrain_config("configs/evokv_root_cause/kuairand_amplified_theta5_refinement_20260809_v1.json")'
test ! -e "$checkpoint_root/theta_5"
...
python scripts/audit_evokv_kuairand_extended_triangle.py \
  ...
  --output "$assessment" \
  --promote-accepted-from "$selection_root/edges/theta_5/accepted.json" \
  --promote-accepted-to "$main_root/edges/theta_5/accepted.json" \
