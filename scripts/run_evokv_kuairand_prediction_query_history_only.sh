...
config=configs/evokv_root_cause/kuairand_prediction_query_history_only_20260808_v6.json
output=results/opportunity_discovery/evokv_kuairand_query_20260808_v0/history_only_seed4217
mkdir -p "$output"
