...
config=configs/evokv_root_cause/kuairand_next_item_recursive_rollout_20260807_v0.json
output=results/opportunity_discovery/evokv_opportunity_discovery_20260807_v0/round_04_r1_next_item_recursive_rollout
mkdir -p "$output"
