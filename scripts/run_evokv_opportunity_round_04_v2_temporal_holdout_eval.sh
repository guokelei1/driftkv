...
config=configs/evokv_root_cause/kuairand_next_item_recursive_rollout_temporal_holdout_theta8_20260807_v0.json
output=results/opportunity_discovery/evokv_opportunity_discovery_20260807_v0/round_04_v2_temporal_holdout_recursive_theta8
mkdir -p "$output"
