...
def complete(path: Path) -> bool:
    ...
    try:
        ...
        return False
    return (
        result.get("protocol") == "residual_transport_discovery_v1"
...
def main() -> None:
    ...
    log_dir = Path("logs/residual_transport_discovery")
    ...
    for tier in TIERS:
        ...
        output = Path(
            ...
            f"{cell}_v2_residual_transport_discovery_seed{seed}.json"
        )
        ...
        command = [
            sys.executable,
            "scripts/residual_transport_search.py",
            "--device",
            args.device,
            "--seed",
            str(seed),
