# Archived: Yambda-50M bring-up plan

Updated: 2026-08-17

> **Historical completed plan.** 本文记录 Yambda 平台如何建立及哪些早期输出被 invalidated，不能作为当前执行入口。历史 compact 见 [P9 时点 Compact](project_compact_pre_p11.md)，当前授权以 [当前路线](../current_route.md) 为准。
