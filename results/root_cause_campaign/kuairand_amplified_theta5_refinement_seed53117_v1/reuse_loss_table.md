# KuaiRand theta1–theta5 Reuse loss
...
## 5x5 triangular matrix: NDCG@5 relative Recompute-over-Reuse

Positive means Recompute is better; negative means Reuse has the higher point estimate.

| current \ cache | theta0 | theta1 | theta2 | theta3 | theta4 |
|---|---:|---:|---:|---:|---:|
| theta1 | +229.276% | — | — | — | — |
| theta2 | +1.115% | +10.089% | — | — | — |
...
## 5x5 triangular matrix: MRR relative Recompute-over-Reuse
...
## 5x5 triangular matrix: HR@5 relative Recompute-over-Reuse
