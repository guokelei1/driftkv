...
| theta9 | -9.262% | -2.866% | -6.338% | +2.119% | -0.613% | -0.416% | -2.402% | +2.395% |

Adjacent: 8/8 positive, mean +5.556%, minimum +1.613%.
All cells: 28/36 positive, mean +6.402%, median +4.403%.
Age accumulation: 5/7 later rows contain an older cache with larger loss than the adjacent cache; 5/7 exceed it by at least one percentage point.
